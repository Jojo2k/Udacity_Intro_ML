...
data_dict = pickle.load( open(r"E:\GitHub\Udacity_Intro_ML\Project_7\final_project_dataset.pkl", "r+b") )
...
for key, value in data_dict.items():
    if value['exercised_stock_options'] != 'NaN':
        val_stock.append(value['exercised_stock_options'])
    if value['salary'] != 'NaN':
        val_salary.append(value['salary'])
